...
class Meteor:
    ...
    def plot_trajectory_geodetic(self) -> None:
        ...
        x, y = m(x, y)
        m.scatter(x, y, marker='o', color='blue')

        # Add time marks
        for i in range(len(x)):
            plot.annotate(self.times_a[i], (x[i], y[i]))
        ...
        x, y = m(x, y)
        m.scatter(x, y, marker='o', color='green')

        # Add time marks
        for i in range(len(x)):
            plot.annotate(self.times_b[i], (x[i], y[i]))
